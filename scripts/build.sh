...
mkdir -p $FABRIC_PATH/vendor/github.com/hyperledger/fabric-chaincode-evm/evmscc
cp -r $EVMSCC_PATH/evmscc/mocks $FABRIC_PATH/vendor/github.com/hyperledger/fabric-chaincode-evm/evmscc/.
cp -r $EVMSCC_PATH/evmscc/statemanager $FABRIC_PATH/vendor/github.com/hyperledger/fabric-chaincode-evm/evmscc/.
